export default function Greet({ dev, imagery }) {
  ...
  return (
    <div id='greet' className=" text-teal-900 flex flex-col items-center font-dm-sans animate-rise-up max-w-[1280px]">
      ...
      <div className="">
        <button onClick={dev} className="m-2 sm:m-5 dark:bg-teal-900 dark:text-white">Development</button>
        <button onClick={imagery} className="m-2 dark:bg-teal-900 dark:text-white">Imagery</button>
      </div>
    </div>
  )
}