...
export default function Greet({ dev, imagery }) {
  ...
  return (
    <div id='greet' className=" text-teal-900 flex flex-col items-center font-dm-sans animate-rise-up max-w-[1280px]">
      ...
      <div className="m-5">
        <Link to='/dev' className="p-3 m-2 sm:m-5 rounded-lg bg-white dark:bg-teal-900 dark:text-white">
          Development
        </Link>
        <Link to='/imagery' className="p-3 m-2 rounded-lg bg-white dark:bg-teal-900 dark:text-white">
          Imagery
        </Link>
      </div>
    </div>
