...
export default function Imagery({ returnHomeHandler }) { 
  ...
  return (
    <>
      <div>
        <HiOutlineHome onClick={returnHomeHandler} className="absolute top-5 left-3 m-5 z-50 text-2xl cursor-pointer text-teal-900 dark:text-orange-50 animate-fade-in"/>
      ...
      <Menu menuStatus={menuStatus} setSlideIndex={setSlideIndex} currentFolder={currentFolder} setCurrentFolder={setCurrentFolder} menuHandler={menuHandler} returnHomeHandler={returnHomeHandler}/>
