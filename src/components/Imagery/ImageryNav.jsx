...
export default function ImageryNav({menuStatus, slideIndex, menuHandler, currentFolder, galleryHandler}) {
  ...
  const navStyles = {
    show: 'fixed flex justify-center bottom-3 inset-x-0 w-full h-[100px] m-5 animate-rise-up',
    hide: 'hidden'
  }
  ...
  return (
    <header className={!menuStatus ? navStyles.show : navStyles.hide}>
      <div className="z-20 bg-orange-100 dark:bg-teal-900 w-fit h-fit py-2 rounded-lg shadow-lg">
