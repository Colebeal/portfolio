...
export default function Menu({
  ...
  const menuStyles = {
    showMain:
      "z-50 opacity-100 fixed flex flex-col bottom-6 right-5 md:top-0 md:right-0 h-[80%] md:h-full w-[90%] md:w-[50%] lg:w-[30%] bg-white dark:bg-[#000000] dark:border-white animate-fade-in rounded-lg shadow-lg border-[1px] border-black",
    hideMain: "hidden",
    showBkg:
