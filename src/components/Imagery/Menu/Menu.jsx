...
export default function Menu({
  ...
  const menuStyles = {
    showMain:
      "z-50 opacity-100 fixed flex flex-col top-[12%] right-5 md:top-0 md:right-0 h-[75%] md:h-full w-[90%] md:w-[30%] bg-white dark:bg-teal-950 animate-fade-in rounded-lg shadow-lg border-[1px] border-black",
    hideMain: "hidden",
    showBkg:
